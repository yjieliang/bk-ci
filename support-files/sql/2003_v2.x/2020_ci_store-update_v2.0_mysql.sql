...
BEGIN
    ...
    IF NOT EXISTS(SELECT 1
        ...
        ALTER TABLE T_STORE_INDEX_ELEMENT_DETAIL ADD ELEMENT_CODE varchar(64) DEFAULT '' NOT NULL COMMENT '指标要素标识';
    ...
    IF NOT EXISTS(SELECT 1
                  ...
                  WHERE TABLE_SCHEMA = db
                    AND TABLE_NAME = 'T_STORE_INDEX_ELEMENT_DETAIL'
                    AND INDEX_NAME = 'UNI_INX_SIE_TYPE_CODE_ELEMENT_CODE') THEN
        ALTER TABLE T_STORE_INDEX_ELEMENT_DETAIL
            ADD INDEX `UNI_INX_SIE_TYPE_CODE_ELEMENT_CODE`(`STORE_TYPE`,`STORE_CODE`,`INDEX_CODE`,`ELEMENT_CODE`);
    END IF;
